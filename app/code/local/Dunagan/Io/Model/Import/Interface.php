...
interface Dunagan_Io_Model_Import_Interface extends Dunagan_Io_Model_Process_Interface
{
    // The following methods are REQUIRED for classes which implement this interface
    /**
     * @param Dunagan_Io_Model_Io_File $ioAdapter - Adapter executing IO functionality
    ...
    // The following instance fields are OPTIONAL to define for subclasses of abstract class Dunagan_Io_Model_Import_Abstract
    /**
