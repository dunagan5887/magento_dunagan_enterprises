...
abstract class Dunagan_Process_Model_Locked_File_Cron_Abstract
    extends Dunagan_Process_Model_Locked_Cron_Abstract
    implements Dunagan_Process_Model_Locked_File_Cron_Interface
{
    ...
    protected function _getIoAdapter()
    {
        ...
        {
            $this->_ioAdapter = Mage::getModel('dunagan_io/io_file')->setAllowCreateFolders(true);
        }
