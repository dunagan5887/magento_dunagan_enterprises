...
$process_queue_task_unique_tablename = $this->getTable('dunagan_process_queue/task_unique');

$installer->getConnection()->dropTable($installer->getTable('dunagan_process_queue/task_unique'));
...
$processQueueTaskUniqueTable =
    $installer->getConnection()
        ...
        ->addColumn(
            ...
            $installer->getIdxName('dunagan_process_queue/task_unique', array('code', 'status', 'last_executed_at')),
            array('code', 'status', 'last_executed_at'),
            array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_INDEX)
        )->addIndex(
            $installer->getIdxName('dunagan_process_queue/task_unique', array('status', 'last_executed_at')),
            array('status', 'last_executed_at'),
            array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_INDEX)
        )->addIndex(
            $installer->getIdxName('dunagan_process_queue/task_unique', array('code', 'unique_id')),
