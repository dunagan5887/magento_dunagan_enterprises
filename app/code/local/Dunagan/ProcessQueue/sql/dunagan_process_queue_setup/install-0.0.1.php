...
$process_queue_task_tablename = $this->getTable('dunagan_process_queue/task');

$installer->getConnection()->dropTable($installer->getTable('dunagan_process_queue/task'));
...
$processQueueTaskTable =
    $installer->getConnection()
        ...
        ->addColumn(
            ...
            $installer->getIdxName('dunagan_process_queue/task', array('code', 'status', 'last_executed_at')),
            array('code', 'status', 'last_executed_at'),
            array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_INDEX)
        )->addIndex(
            $installer->getIdxName('dunagan_process_queue/task', array('status', 'last_executed_at')),
